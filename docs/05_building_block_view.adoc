...
****
Here is the building block view which shows the static decomposition of the system into building blocks, it includes libraries, modules, components... An also the dependencies among them.
