...
¿MVC?
Modular por entidades
funcionalidades por separado
client servidor
_<explanation>_
...
restapi:
    routes: logica de negocio, separado por entidad
    models: representaciones
    service: ba
...
=== Efficiency
codigo de calidad para que se ejecute mas rapido
no se que decir, 
