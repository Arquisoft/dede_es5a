...
=== Architecture and Design Patterns
image:https://webimages.mongodb.com/_com_assets/cms/mern-stack-b9q1kbudz0.png?auto=format%2Ccompress["MERN Stack Architecture"]
...
*restapi* mainly contains:
    ...
    * *services* contains global services like database conection.
...
====== Main page
image:main.png["Main page"]

====== Cart screen
image:cart.png["Cart screen"]

====== Product's detail screen
image:productDetail.png["Product's detail screen"]

====== Sign up/Log in screen
image:signUp.png["Sign up screen"]
image:logIn.png["Log in screen"]

====== User's profile screen
image:userProfile.png["User's profile screen"]
