...
|5|Availability|The application will available the majority of time. System's availability will always be upper to 98%. This will reduce money loss due to system failures.
|===
