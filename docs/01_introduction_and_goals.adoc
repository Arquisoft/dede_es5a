...
| _Users_ | _People intrested in buying online products while maintaining their privacy._ | _To have an application that allows making purchases and at the same time managing the shared data._
