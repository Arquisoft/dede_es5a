            ...
            <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gridTemplateRows="repeat(4, 1fr)" >
                ...
                <Box gridArea="1/5/4/11" sx={{ ml: "0.5em", mr: "0.5em" }}>
                    <Box display="grid" gridTemplateColumns="repeat(3, 1fr)">
                        ...
                        <Typography display='inline' align='right' variant='subtitle1' color="#787878">{product.quantity == 1 ? '' : product.quantity + 'x'}</Typography>
                        <Typography display='inline' variant='subtitle1'>{product.price} €</Typography>
                    </Box>
